...
options:
    state:
        description:
            - Set the to be either I(present) or I(absent).
        default: "present"
        choices:
            - present
            - absent
    ...
    namespace:
        description:
            - Namespace where the template exists.
        required: true
        type: str
    objects:
        description:
    ...
    version:
        description: ""
            - "Specify the version of the template."
        type: str
    ...
    def execute_module(self):
        ...
        for obj in objects:
            if obj['kind'] != 'VirtualMachine':
                ...
                vm_definition['apiVersion'] = API_VERSION

                # Contruct k8s vm API object:
                vm_template = vm_definition['spec']['template']
                _, vm_def = self.construct_vm_template_definition('VirtualMachine', vm_definition, vm_template, obj)
